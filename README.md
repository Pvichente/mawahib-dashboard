...
1. **User Database:** Demographic and registration details.
2. **Funnel Data:** Conversion metrics across the learning path.
3. **Content Progress:** Engagement metrics from the Enably platform modules.
